          ...
          {!editingProfile ? (
            <div>
              <div style={{display:"flex",alignItems:"center",gap:12,padding:"4px 0"}}>
                ...
                <button onClick={() => { setEditUsername(user.username); setEditingProfile(true); }}
            ...
            <div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:12,marginBottom:14}}>
                ...
                {user.email && <div>
                  ...
                  <div style={{color:"#8a8aa0",fontSize:13,padding:"9px 0"}}>{user.email}</div>
                </div>}
                <div>
                  <div style={{color:"#6b6b80",fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:4}}>Password</div>
                  <button disabled={changingPassword} onClick={async () => {
                    ...
                    style={{background:"none",border:"1px solid #2a2a45",borderRadius:8,padding:"9px 16px",color:"#818cf8",fontSize:12,cursor:changingPassword?"default":"pointer",fontWeight:600,opacity:changingPassword?0.5:1}}>
